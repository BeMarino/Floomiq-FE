            ...
            <div className='row'>
                <div className='p-4 flex flex-col w-[18%] rounded-lg bg-[#F3F3F3] h-[73vh] gap-8'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link className='flex flex-row text-lg gap-2 rounded-full py-2 px-4'  hover={path!=="/projects" && "bg-gray-400"} style={path==="/my-projects" ?{"background-color":  "#DEFE9A"}:{"background-color":  ""}}>
                            <BsBagHeart />
                            <div className='text-left text-sm 0'>
                                Preferiti
                            </div>
                        </Link>
                        <Link to="/my-projects" className='flex flex-row text-lg gap-2 rounded-full py-2 px-4 hover:bg-gray-400' hover={path!=="/projects" && "bg-gray-400"} style={path==="/projects" ?{"background-color":  "#DEFE9A"}:{"background-color":  ""}}>
                            <IoLibraryOutline />
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link className='flex flex-row text-lg gap-2 rounded-full  py-2 px-4'>
