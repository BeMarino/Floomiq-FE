...
export default function NewFavouriteDialog({ plant, setShowNewFavourite }) {
    const closeDialog=()=>{
        setShowNewFavourite(false);
    }
    return (
            ...
            <div className="flex flex-row divide-x-2 divide-solid divide-emerald-500 py-2 w-1/2 mt-[10%] ml-[25%] border-solid border-2 border-slate-300	bg-white  rounded self-center">
                ...
                <div className="flex alert-white">
                    <div className="flex flex-col justify-between p-2">
                        ...
                        <span className="flex font-light text-left">Hai aggiunto {plant} ai preferiti!</span>
                        <div>

                            <div className="flex flex-row">
                            <span className="flex font-light text-left">Accedi alla sezione &#8202;
                                <Link to="/my-favourite" className="flex text-left font-medium underline text-balance text-green-700">
                                    I miei preferiti
                                </Link>
                                &#8202; per visualizzarli.</span></div>
