...
class SideCart extends React.Component {
    ...
    render() {
        if (this.props.openSideCart) {
            return (
                <div className='sideCart'>
                    <button className='is-primary controlSideCart' onClick={this.props.toggleCart}>
            ...
            <div className='openSideCart'>
                <button className='price' onClick={this.props.toggleCart}><IoMdArrowDropleft/></button>
                <GiHighGrass/>
