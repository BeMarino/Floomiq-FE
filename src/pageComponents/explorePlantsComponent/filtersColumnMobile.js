...
export default function FiltersColumnMobile({ setFilters, filters }) {
    ...
    return (
        <div className="filters-column-mobile sm:hidden overflow-y-scroll">
    ...
    /* return (
        <div className="filters-column-mobile overflow-y-scroll">
            <div className="collapsable-filters cursor-pointer ">
                <div className="filter-type hover:bg-lime-200 p-1 rounded-md  pb-1" onClick={() => toggle(setOpenTipoPianta, openTipoPianta)}>
                    Tipo di pianta
                    <div>{openTipoPianta ? <IoIosArrowUp /> : <IoIosArrowDown />}</div>
            ...
            <div className='flex flex-row gap-1 w-[90%] ml-[5%] justify-between'>
                <span className='filter-type'>Pianta da interno</span>
                <ButtonSwitch className="w-1/4" selected={filters["obj"]["Interno"]}
                    filter={{ tag: "Interno", obj: { Interno: true } }} handler={handleSwitchToggle} />
            </div>
            <div className='flex flex-row gap-1 w-[90%] ml-[5%] justify-between'>
                <span className='filter-type'>Pianta da esterno</span>
